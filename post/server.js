...
// var { wykonaj, sell, rent, retur, availability, showBought, showRented } = require('../lab5/dealer_script_lab5')
// var { wykonaj, sell, rent, retur, availability, showBought, showRented } = await import('../lab5/dealer_script_lab5')
    ...
    if (url.pathname == '/submit') { // Processing the form content, if the relative URL is '/submit'
        ...
        if (request.method == 'GET'){ // If the GET method was used to send data to the server
            ...
            request.on('end', function () {
                ...
                console.log('post.command: ' + post.command)
                let commands = post.command.split(' ')
                ...
                <html lang="pl">
                  ...
                  <body>
                    ...
                    <form method="POST" action="/submit" class="w3-margin">
